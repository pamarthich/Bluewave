# Generated by Django 2.1.1 on 2018-11-30 06:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='topics', to='products.Board')),
        ...
        migrations.AddField(
            model_name='post',
            name='topic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='posts', to='products.Topic'),
        ),
        migrations.AddField(
            model_name='post',
            name='updated_by',
